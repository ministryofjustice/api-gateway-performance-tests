...
ENDPOINTS = [
  ...
  { endpoint: "#{BASE_URL}/prison/PRISON_ID/offenders/NOMS_ID/accounts/spends/transactions?from_date=2017-09-26", method: :get },
  # DATETIME FORMAT: 2017-10-24%2015:36:24.380
  { endpoint: "#{BASE_URL}/offenders/events?prison_id=PRISON_ID&from_datetime=2017-10-26%2012:04:31.777", method: :get },
  { endpoint: "#{BASE_URL}/lookup/active_offender?date_of_birth=1993-12-17&noms_id=NOMS_ID", method: :get },
  ...
  { endpoint: "#{BASE_URL}/offenders/events/case_notes?from_datetime=2017-09-29T13:55:06.000Z", method: :get },
  { endpoint: "#{BASE_URL}/offenders/events/case_notes_for_delius?from_datetime=2017-10-05T10:23:53.000Z", method: :get },
